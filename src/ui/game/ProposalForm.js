...
export default class ProposalForm extends Component {
  ...
  _onChangeRuleset = (e: Object) => {
    ...
    this.props.onChangeProposal(
      {...proposal, rules: {...proposal.rules, rules}}
    );
  }
  ...
  _onSizeMinus = () => {
    ...
    this.props.onChangeProposal(
      {...proposal, rules: {...proposal.rules, size}}
    );
  }
  ...
  _onHandiMinus = () => {
    ...
    this.props.onChangeProposal(
      {...proposal, rules: {...proposal.rules, handicap}}
    );
  }
  ...
  _onKomiMinus = () => {
    ...
    this.props.onChangeProposal(
      {...proposal, rules: {...proposal.rules, komi}}
    );
  }
  ...
  _onMainTimeMinus = () => {
    ...
    this.props.onChangeProposal(
      {...proposal, rules: {...proposal.rules, mainTime}}
    );
  }
  ...
  _onPeriodsMinus = () => {
    ...
    this.props.onChangeProposal(
      {...proposal, rules: {...proposal.rules, byoYomiPeriods}}
    );
  }

  _onPeriodsPlus = () => {
    let {proposal} = this.props;
    let byoYomiPeriods = Math.min(100, (proposal.rules.byoYomiPeriods || 5) + 1);
    this.props.onChangeProposal(
      {...proposal, rules: {...proposal.rules, byoYomiPeriods}}
    );
  }
