...
export default class GamePlayActions extends Component<$FlowFixMeState> {
  ...
  render() {
    ...
    let passClassName = 'GamePlayActions-item-button GamePlayActions-pass' + (
      ...
      <div className='GamePlayActions'>
        {scoring ?
          <div className='GamePlayActions-item'>
            <A className='GamePlayActions-item-button GamePlayActions-done' onClick={this._onDone}>
              Done
            </A>
          </div> :
          <div className='GamePlayActions-item'>
        ...
        <div className='GamePlayActions-item'>
          <A className='GamePlayActions-item-button GamePlayActions-undo' onClick={this._onUndo}>
            Undo
          </A>
        </div>
        <div className='GamePlayActions-item'>
          <A className='GamePlayActions-item-button GamePlayActions-resign' onClick={this._onResign}>
            Resign
          </A>
        </div>
        <div className='GamePlayActions-item'>
          <div className='GamePlayActions-more-container' ref={this._setMoreEl}>
            <A className='GamePlayActions-item-button GamePlayActions-more' onClick={this._onToggleMore}>
              More <Icon name='angle-down' />
            </A>
            {moreShowing ?
              <div className='GamePlayActions-more-menu'>
                <A className='GamePlayActions-more-item' onClick={this._onAdd1Minute}>
                  Add 1 Minute
                </A>
                <A className='GamePlayActions-more-item' onClick={this._onAdd5Minutes}>
                  Add 5 Minutes
                </A>
                <div className='GamePlayActions-more-menu-separator' />
                <A className='GamePlayActions-more-item GamePlayActions-leave' onClick={this._onLeaveGame}>
                  Leave Game
                </A>
              </div> : null}
          </div>
